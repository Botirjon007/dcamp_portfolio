                ...
                <div class="flex flex-col md:flex-row -mx-4">
                    ...
                    <main class="md:w-2/3 lg:w-3/4 px-4">
                        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                            <h1 class="text-3xl my-5 ml-4 font-bold">12 Orders</h1>
                            <table class="w-full text-sm text-left">
                                ...
                                <tbody>
                                    <tr class="bg-white">
                                        <td class="px-6 py-2">12345667</td>
                                        <td class="px-6 py-2">$232</td>
                                        <td class="px-6 py-2">Processing</td>
                                        <td class="px-6 py-2">
                                            <div><a class="px-2 py-2 inline-block text-yellow-600 bg-white shadow-sm border border-gray-200 rounded-md hover:bg-gray-100 cursor-pointer mr-2" href="/admin/orders/12345667"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                                                <a
                                                    class="px-2 py-2 inline-block text-red-600 bg-white shadow-sm border border-gray-200 rounded-md hover:bg-gray-100 cursor-pointer"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
